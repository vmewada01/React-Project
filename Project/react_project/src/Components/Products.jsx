...
const Products = () => {
  ...
  function filterDataAscending() {
    setFilter(items.slice().sort((a, b) => a.price - b.price));
  }

  function filterDataDecending() {
    setFilter(items.slice().sort((a, b) => b.price - a.price));
  }

  function filterDataOneToFive(p, t) {
    setFilter(items.filter((abc) => abc.price > p && abc.price < t));
  }

  function filterbyBrandTannerWood() {
    setFilter(items.filter((abc) => abc.brand == "TANNER GOODS"));
  }

  function filterbyBrandMazama() {
    setFilter(items.filter((abc) => abc.brand == "MAZAMA"));
  }
  ...
  return (
    <Box>
      ...
      >
        ...
        <Button
          onClick={filterbyBrandTannerWood}
          color="white"
          size="lg"
          bg="rgb(198,156,109)"
        >
        ...
        <Button
          ...
          size="lg"
          bg="rgb(198,156,109)"
          onClick={() => filterDataOneToFive(0, 500)}
        >
          0-500 $
        </Button>
        <Button
          ...
          size="lg"
          bg="rgb(198,156,109)"
          onClick={() => filterDataOneToFive(500, 2000)}
        >
          500 $ && ABOVE
        </Button>
      </Flex>
